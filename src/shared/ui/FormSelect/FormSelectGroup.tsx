...
const FormSelectGroup = ({
  ...
  helperText,
  register,
}: PropsWithChildren<FormSelectGroupProps>) => {
  return (
    <div>
      <div className="relative mb-4">
        <select
          id={id}
          className={`block px-2.5 pb-2.5 pt-4 w-full text-base text-text
            bg-transparent rounded-lg border-2 border-gray-700 
            ${error ? "border-red-700" : ""} appearance-none
